...
<div class="slideshow">
    ...
    <div class="slideshow-wrapper">
        <div class="slide">
            <img class="slide-img" src="img\b1.png" />
        </div>
        <div class="slide">
            <img class="slide-img" src="img\b2.png" />
        </div>
        <div class="slide">
            <img class="slide-img" src="img\nb.png" />
        </div>
        <div class="slide">
            <img class="slide-img" src="img\b4.png" />
        </div>
    </div>
</div>
<!-- Carousel wrapper -->
...
$query_produk = "SELECT p.nama, p.harga, p.gambar 
                 ...
                 WHERE k.nama_kategori = 'Bracelet'";
...
<div class="produk1" id="prod-1">
    <h2>THIS IS OUR BRACELETS COLLECTIONS</h2>
