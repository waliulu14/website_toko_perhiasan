...
<div class="slideshow">
    ...
    <div class="slideshow-wrapper">
        <div class="slide">
            <img class="slide-img" src="img\r1.png" />
        </div>
        <div class="slide">
            <img class="slide-img" src="img\r2.png" />
        </div>
        <div class="slide">
            <img class="slide-img" src="img\r3.png" />
        </div>
        <div class="slide">
            <img class="slide-img" src="img\r4.png" />
        </div>
    </div>
</div>
<!-- Carousel wrapper -->
...
<div class="produk1" id="prod-1">
    <h2>THIS IS OUR RINGS COLLECTIONS</h2>
